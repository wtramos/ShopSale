namespace ShopSale.Common.Services
{
    using System;
    ...
    public class ApiService : IApiService
    {
        ...
        public async Task<Response> RegisterUserAsync(string urlBase,
                                                      string servicePrefix,
                                                      string controller,
        ...
        public async Task<Response> GetUserByEmailAsync(string urlBase,
                                                        string servicePrefix,
                                                        string controller,
                                                        string email,
                                                        string tokenType,
